...
{
    const float A00 = A.cols[0].x;
    auto A10 = A.cols[0].y;
    auto A20 = A.cols[0].z;
    const float A01 = A.cols[1].x;
    auto A11 = A.cols[1].y;
    auto A21 = A.cols[1].z;
    const float A02 = A.cols[2].x;
    auto A12 = A.cols[2].y;
    auto A22 = A.cols[2].z;

    const float B00 = B.cols[0].x;
    auto B10 = B.cols[0].y;
    auto B20 = B.cols[0].z;
    const float B01 = B.cols[1].x;
    auto B11 = B.cols[1].y;
    auto B21 = B.cols[1].z;
    const float B02 = B.cols[2].x;
    auto B12 = B.cols[2].y;
    auto B22 = B.cols[2].z;
